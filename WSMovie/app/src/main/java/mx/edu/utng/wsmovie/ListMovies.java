...
/**
 * Created by Toshinalap on 29/03/2017.
 */
            ...
            try {
                ...
                if (response != null) {
                    for (SoapObject objSoap : response) {
                        ...
                        movie.setProperty(3, Float.parseFloat(objSoap.getProperty("price").toString()));
                        movie.setProperty(4, Integer.parseInt(objSoap.getProperty("type").toString()));
                        movies.add(movie);
                    }
                }
